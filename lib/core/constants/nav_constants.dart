...
import 'package:code_capital/features/jobs/view/pages/jobs_page.dart';
import 'package:flutter/material.dart';

class NavConstants {
  static final navList = [
    (title: 'Home', icon: Icons.home_rounded, page: GameHomePage()),
    (title: 'Employees', icon: Icons.people_alt_rounded, page: EmployeesPage()),
    (title: 'Jobs', icon: Icons.business_rounded, page: JobsPage()),
